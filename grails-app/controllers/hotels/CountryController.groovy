...
class CountryController {
    ...
    def index(Integer max) {
        ...
        def countryName = params.name ? params.name : ""
        def countryList = countryService.getAllCountriesByName(countryName, params)
        respond countryList, model:[countryCount: countryList.totalCount]
    }
    def show(Long id) {
